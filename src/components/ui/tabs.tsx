...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex md:flex-row flex-col h-10 items-center md:border dark:border-none justify-center rounded-full md:bg-muted bg-white p-1 text-muted-foreground dark:md:bg-secondary xl:max-w-[520px] w-full",
      className
    )}
    {...props}
  />
